...
interface RequestModalProps {} // eslint-disable-line
        ...
        <div className="relative rounded-lg bg-wallet shadow dark:bg-gray-700">
          ...
          <div className="p-6">
            <span className="font-comic text-[16px] font-normal text-gray-500 dark:text-gray-400">
              {`Live Auction. Doge Not enter. Connect wallet. Hehe. Hehe love desktop. On mobile, use browser in Metamask app!`}
            </span>
          </div>
        </div>
      </div>
